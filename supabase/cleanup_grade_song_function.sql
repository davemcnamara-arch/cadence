-- Cleanup script to remove ALL versions of grade_song function
-- Run this in Supabase SQL Editor to fix the function overload error

-- Drop all possible versions of the grade_song function
DROP FUNCTION IF EXISTS grade_song(UUID, TEXT, TEXT, UUID, INTEGER, JSONB, TEXT, TEXT, TEXT, TEXT, BOOLEAN);
DROP FUNCTION IF EXISTS grade_song(UUID, TEXT, TEXT, UUID, INTEGER, JSONB, TEXT, TEXT, TEXT, BOOLEAN);

-- Create the correct version without spotify_url parameter
