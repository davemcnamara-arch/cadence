-- Add pending_count to get_teacher_classes function
-- This shows how many students are pending enrollment for each class
...
BEGIN
  ...
  -- Get classes for the teacher with student counts and pending counts
