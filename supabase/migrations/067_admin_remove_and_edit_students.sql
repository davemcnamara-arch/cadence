-- Allow admins to remove students from and edit students in any teacher's class
-- Previously, remove_student_from_class and update_student_name only authorized
-- the class teacher. This migration adds admin authorization to both functions.

-- ============================================================================
-- 1. Update remove_student_from_class to allow admin access
-- ============================================================================
...
-- ============================================================================
-- 2. Update update_student_name to allow admin access
-- ============================================================================
