-- Add notes column to song_ratings table for teacher/student comments

ALTER TABLE song_ratings
ADD COLUMN notes TEXT;

-- Update the update_song_rating function to include notes
...
GRANT EXECUTE ON FUNCTION update_song_rating(UUID, INTEGER, TEXT) TO authenticated;

-- Update the grade_song function to include notes parameter
...
-- Update grant for new signature
GRANT EXECUTE ON FUNCTION grade_song(UUID, TEXT, TEXT, UUID, INTEGER, JSONB, TEXT, TEXT, TEXT, BOOLEAN, TEXT) TO authenticated;
