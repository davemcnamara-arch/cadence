-- Drop all versions of grade_song function to fix overloading issue
...
DROP FUNCTION IF EXISTS grade_song(uuid, text, text, uuid, integer, jsonb);

-- Create single clean version of grade_song
